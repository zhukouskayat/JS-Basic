...
console.log(`Сумма чисел находящихся на главной диагонали = ${sumMainDiagonal}`);
...
console.log(`Сумма чисел находящихся на вспомогательной диагонали = ${sumSecondDiagonal}`);
...
console.log(`Среднее геометрическое чисел находящихся на вспомогательной диагонали = ${gAverageSecondDiagonal}`);
...
console.log(`Cумма всех элементов для каждого чётного столбца = ${sumEveryEvenCol}`);
...
console.log(`Среднее арифметическое сумм чисел всех нечетных строк = ${averageAllOddRows}`);
...
console.log(`Среднее арифметическое сумм чисел нечетных строк = ${averageEveryOddRow}`);
...
console.log(`Максимальное число для каждого столбца матрицы = ${maxValueColMatrix}`);
...
// console.log(`Минимальное число для каждого столбца матрицы = ${minValueColMatrix}`);
...
console.log(`Максимальное число для каждого столбца матрицы = ${maxValueRowMatrix}`);
...
// console.log(`Минимальное число для каждого столбца матрицы = ${minValueRowMatrix}`);
...
console.log(`Сумма чисел в верхнем треугольнике относительно главной диагонали включая диагональ = ${sumUpperTriangleW}`);
...
console.log(`Сумма чисел в верхнем треугольнике относительно главной диагонали не включая диагональ = ${sumUpperTriangle}`);
...
console.log(`Сумма чисел в верхнем треугольнике относительно вспомогательной диагонали включая диагональ = ${sumUpperSecondTriangleW}`);
...
console.log(`Сумма чисел в верхнем треугольнике относительно главной диагонали не включая диагональ = ${sumUpperSecondTriangle}`);
...
console.log(`Сумма чисел в нижнем треугольнике относительно вспомогательной диагонали включая диагональ = ${sumDownSecondTriangleW}`);
...
console.log(`Сумма чисел в нижнем треугольнике относительно вспомогательной диагонали не включая диагональ = ${sumDownSecondTriangle}`);